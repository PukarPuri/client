    ...
    <div style={{ backgroundColor: '#f5f5f5', fontFamily: 'Arial, sans-serif', margin: '0', padding: '0', boxSizing: 'border-box' }}>
      <header style={{ backgroundColor: '#fff', padding: '20px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Link to="/" style={{ display: 'inline-block', marginRight: '20px' }}>
          ...
          <nav style={{ display: 'flex' }}>
            ...
            <Link to="/properties" style={{ marginRight: '20px', textDecoration: 'none', color: '#333' }}>Properties</Link>
            <Link to="/wishlist" style={{ marginRight: '20px', textDecoration: 'none', color: '#333' }}>Wishlist</Link>
            <Link to="/why-choose-us" style={{ textDecoration: 'none', color: '#333' }}>Why Choose Us</Link>
          </nav>
        </div>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Link to="/register">
